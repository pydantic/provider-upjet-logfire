...
// ResolveReferences of this ReadToken.
func (mg *ReadToken) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this WriteToken.
func (mg *WriteToken) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
